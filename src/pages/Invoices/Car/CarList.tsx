...
import { listVehicle } from "../../../services/vehicle"; // Import updateVehicle function
...
const CarList = () => {
  ...
  const handleDeleteVehicle = async () => {
    if (selectedVehicle) {
      try {
        ...
        const response = await fetch(`${API_BASE_URL}/vehicle/deleteVehicle/${selectedVehicle._id}`, {
          method: "DELETE",
          headers: {
  ...
  const deleteMultiple = async () => {
    try {
      ...
      await Promise.all(selectedCheckBoxDelete.map(async (id) => {
        const response = await fetch(`${API_BASE_URL}/vehicle/deleteVehicle/${id}`, {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const handleUpdateVehicle = async () => {
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/vehicle/updateVehicle`, {
        method: "PUT",
        headers: {
